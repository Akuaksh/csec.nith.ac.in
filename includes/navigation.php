   ...
   <meta name="author" content="CSEC-NITH">
	...
	<div class="header">
		...
		<ul class="parent_list" id="navbar">
			...
			<li><a href="/pages/cons.php" >Activities</a></li>
			<ul class="nested_list">
				<li><a href="/pages/cons.php" >C lectures</a></li>
				<li><a href="/pages/cons.php" >Codemons</a></li>
				<li><a href="/pages/cons.php" >Web development</a></li>
				<li><a href="/pages/cons.php" >Python</a></li>
				<li><a href="/pages/cons.php" >Workshops</a></li>
			</ul>
